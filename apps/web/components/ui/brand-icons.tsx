...
function BrandIcon({ size = 16, className = "", children }: BrandIconProps & { children: ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TwitterIcon({ size = 16, className }: BrandIconProps) {
  return (
    <BrandIcon size={size} className={className}>
